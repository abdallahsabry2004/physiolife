...
function PatientDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ============================================================== */}
      {/* 🖨️ منطقة الطباعة المعزولة (باستخدام الجدول السحري HTML Table) */}
      {/* ============================================================== */}
      {isPrintingProfile && (
        <div className="isolated-print-container hidden print:block w-full">
          
          {/* 1. الفوتر الثابت الحقيقي */}
          ...
          {/* 2. الجدول الذي يقوم بهندسة المحتوى ومنع التداخل */}
          <table className="w-full border-none">
            
            {/* الترويسة (Header) - تتكرر في كل صفحة لو كانت طويلة */}
            ...
            {/* المساحة السحرية التي تحمي الفوتر من التداخل (tfoot) */}
            <tfoot className="print:table-footer-group">
              <tr>
                <td className="p-0 border-none">
                  {/* ارتفاع هذه المساحة يجب أن يكون مساوياً لارتفاع الفوتر الثابت (25mm) */}
