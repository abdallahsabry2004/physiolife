...
function PatientDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* هيدر ثابت يتكرر تلقائيًا أعلى كل صفحة طباعة (لا يظهر على الشاشة) */}
      <PrintHeader
        documentTitle="Clinical Record"
        patientName={patient.full_name}
        patientCode={patient.code}
      />

      {/* فوتر ثابت يتكرر تلقائيًا أسفل كل صفحة طباعة (لا يظهر على الشاشة) */}
      <PrintFooter
        note={`Printed by ${fullName} · ${new Date().toLocaleString('en-GB')}`}
      />

      {/* بطاقة بيانات المريض الكاملة — تظهر مرة واحدة فقط أعلى أول صفحة مطبوعة،
          أسفل الهيدر الثابت مباشرة، ولا تتكرر في باقي الصفحات */}
      <div className="hidden print:block border-2 border-gray-200 rounded-xl p-4 mb-6 break-inside-avoid">
