...
export function logActivityAsync(logData: {
  ...
  if (!GOOGLE_SHEETS_WEBHOOK_URL || GOOGLE_SHEETS_WEBHOOK_URL === "https://script.google.com/macros/s/AKfycbyxxUpADjcTvmW0h6Zc-YrqBFAn9_K9ZMJGMJCSxcCu6iDFet-lwdN3ggCZ8zZOZp9p/exec") return;
